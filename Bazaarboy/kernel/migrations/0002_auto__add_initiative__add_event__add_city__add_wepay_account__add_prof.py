...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('kernel_initiative', (
            ...
            ('community', self.gf('django.db.models.fields.related.ForeignKey')(related_name='initiative_community', to=orm['kernel.Community'])),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(related_name='initiative_city', to=orm['kernel.City'])),
        ...
        db.create_table('kernel_event', (
            ...
            ('category', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['kernel.Profile'])),
            ('community', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_community', to=orm['kernel.Community'])),
            ('city', self.gf('django.db.models.fields.related.ForeignKey')(related_name='event_city', to=orm['kernel.City'])),
    ...
    models = {
        ...
        'kernel.event': {
            ...
            'city': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_city'", 'to': "orm['kernel.City']"}),
            'community': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'event_community'", 'to': "orm['kernel.Community']"}),
            'description': ('django.db.models.fields.TextField', [], {}),
        ...
        'kernel.initiative': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'city': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'initiative_city'", 'to': "orm['kernel.City']"}),
            'community': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'initiative_community'", 'to': "orm['kernel.Community']"}),
