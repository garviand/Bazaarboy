...
Bazaarboy.event.manage = {
  ...
  add_purchase: function() {
    ...
    Bazaarboy.post('event/purchase/add/', params, (function(_this) {
  ...
  filterGuests: function(param, value, ticketType, checkStatus, updateListLength) {
    var i, j, length, newLength, newLengthChecked, ref, rsvp, targetValue, ticketCheck;
    ...
    $('form[name=add-guest] select[name=ticket]').change(function(e) {
      if ($(this).val() === '-1') {
        ...
        Bazaarboy.get('event/ticket/', {
          ...
          var allOptions, extra_fields, fieldName, fieldOptions, j, len, newInput, option;
