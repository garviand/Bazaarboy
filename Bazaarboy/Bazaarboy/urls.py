...
list_urlpatterns = patterns('src.controllers.list', 
    ...
    url(r'^signup/(?P<signup>\d+)/$', 'sign_up', name = 'sign-up'),
    url(r'^signup/(?P<signup>\d+)/manage/$', 'manage_sign_up', name = 'manage-sign-up'),
    url(r'^signup/(?P<signup>\d+)/edit/$', 'edit_sign_up', name = 'edit-sign-up'),
    url(r'^signup/new/$', 'new_sign_up', name = 'new-sign-up'),
    url(r'^signup/save/$', 'save_sign_up', name = 'save-sign-up'),
    url(r'^signup/delete/$', 'delete_sign_up', name = 'delete-sign-up'),
    url(r'^signup/create/$', 'create_sign_up', name = 'create-sign-up'),
    url(r'^signup/submit/$', 'submit_sign_up', name = 'submit-sign-up'),
    url(r'^create/$', 'create', name = 'create'),
    ...
    url(r'^add/signup/$', 'add_from_sign_up', name = 'add_from_sign_up'),
...
event_urlpatterns = patterns('src.controllers.event', 
    ...
    url(r'^search/$', 'search', name = 'search'),
    url(r'^instagram/$', 'instagram_photos', name = 'instagram_photos'),
...
reward_urlpatterns = patterns('src.controllers.reward',
    ...
    url(r'^request/create/$', 'create_request', name = 'create-request'),
    url(r'^request/reject/$', 'reject_request', name = 'reject-request'),
    url(r'^request/(?P<request_id>\d+)/$', 'request_response', name = 'request-response'),
    url(r'^subscribe/$', 'subscribe', name = 'subscribe'),
    url(r'^(?P<reward>\d+)/manage/$', 'manage', name = 'manage'),
    url(r'^item/add/$', 'add_item', name = 'add-item'),
    url(r'^item/delete/$', 'delete_item', name = 'delete-item'),
