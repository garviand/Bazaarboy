...
urlpatterns = patterns('',
    ...
    url(r'^fundraiser/reward/create/$', 
        'src.controllers.fundraiser.create_reward', 
        name = 'fundraiser-reward-create'),
    url(r'^fundraiser/reward/edit/$', 'src.controllers.fundraiser.edit_reward', 
        name = 'fundraiser-reward-edit'),
    url(r'^fundraiser/reward/delete/$', 
        'src.controllers.fundraiser.delete_reward', 
        name = 'fundraiser-reward-delete'),
